    ...
    <div className="flex flex-col sm:flex-row items-center gap-4 mb-6 bg-slate-100 p-4 rounded-lg shadow-md">
      ...
      <div className="relative w-full sm:w-2/3">
        ...
        <input
          ...
          value={searchQuery}
          // Dispatches the search query to Redux store when user types
      ...
      <select
        ...
        //Dispatches selected category to Redux store on change
        onChange={(e) => dispatch(setSelectedCategory(e.target.value))}
      >
        {/* Option for all categories */}
        <option value="all">🌍 All Categories</option>
        {/* Different job category options */}
      ...
      {/* Button to Navigate to Job Analysis Page */}
      <Link
        href="/analysis"
